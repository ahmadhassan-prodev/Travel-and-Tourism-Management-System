...
public class BookHotel extends JFrame implements ActionListener {
    ...
    BookHotel(String username) {
        ...
        setBounds(320, 160, 1000, 565);
        setLayout(null);
        getContentPane().setBackground(Color.WHITE);

        JLabel text = new JLabel("BOOK HOTEL");
        text.setBounds(130, 10, 200, 30);
        text.setFont(new Font("Tahoma", Font.BOLD, 20)); // line 14
        add(text);
        ...
        Image i2 = i1.getImage().getScaledInstance(600, 300, Image.SCALE_AREA_AVERAGING);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel l12 = new JLabel(i3);
        l12.setBounds(480, 50, 480, 300);
        add(l12);
        setVisible(true);
